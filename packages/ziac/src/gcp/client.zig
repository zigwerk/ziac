...
pub const Endpoints = struct {
    ...
    organization_policy: []const u8 = "https://orgpolicy.googleapis.com",
    access_context_manager: []const u8 = "https://accesscontextmanager.googleapis.com",
    security_center: []const u8 = "https://securitycenter.googleapis.com",
    binary_authorization: []const u8 = "https://binaryauthorization.googleapis.com",
    private_ca: []const u8 = "https://privateca.googleapis.com",
    data_pipelines: []const u8 = "https://datapipelines.googleapis.com",
    dataflow: []const u8 = "https://dataflow.googleapis.com",
    dataform: []const u8 = "https://dataform.googleapis.com",
    dataproc: []const u8 = "https://dataproc.googleapis.com",
    ...
    eventarc_publishing: []const u8 = "https://eventarcpublishing.googleapis.com",
    connectors: []const u8 = "https://connectors.googleapis.com",
    vertex_ai: []const u8 = "https://aiplatform.googleapis.com",
    ...
    pub fn get(self: Endpoints, api: Api) []const u8 {
        return switch (api) {
            ...
            .access_context_manager => self.access_context_manager,
            ...
            .eventarc_publishing => self.eventarc_publishing,
