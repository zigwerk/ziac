...
pub const sources = [_]Source{
    ...
    .{
        ...
        .version = "v1b3",
        .revision = "20260708",
        .discovery_url = "https://dataflow.googleapis.com/$discovery/rest?version=v1b3",
        .document_sha256 = "f916f42da2d74bdad508f64eca160ba1d17e7e37c7916bbb7ecb7ce94d45e842",
    },
    .{
        .id = "dataform:v1beta1",
        .version = "v1beta1",
        .revision = "20260702",
        .discovery_url = "https://dataform.googleapis.com/$discovery/rest?version=v1beta1",
        .document_sha256 = "17c7b6b738e05cfbd9e72a24b476f57fa8cba3cb847c080d489d140e67fd799b",
    },
    .{
        .id = "datapipelines:v1",
        .version = "v1",
        .revision = "20260705",
        .discovery_url = "https://datapipelines.googleapis.com/$discovery/rest?version=v1",
        .document_sha256 = "451ec2ec62331846dda5b65a8e2e213fa0abe71f88e63e796952319ae721547a",
    },
    .{
        .id = "dataproc:v1",
        .version = "v1",
        .revision = "20260625",
        .discovery_url = "https://dataproc.googleapis.com/$discovery/rest?version=v1",
        .document_sha256 = "2be999f4ce31c3d7b52d7f51c93ac1bf323fd45c10234a7aaa7fac47a4ec69f7",
    },
    .{
        .id = "dns:v1",
        .version = "v1",
