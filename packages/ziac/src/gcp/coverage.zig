...
pub const resources = [_]Resource{
    ...
    managed("gcp.artifact.ProjectSettings", .artifact_registry, .project, .google_discovery, "M75", retained),
    managed("gcp.artifact.Repository", .artifact_registry, .location, .google_discovery, "M75", withProduct(full)),
    managed("gcp.artifact.VpcscConfig", .artifact_registry, .location, .google_discovery, "M75", retained),
    ...
    managed("gcp.billing.ProjectBillingAssociation", .cloud_billing, .project, .google_discovery, "M78", withProduct(full)),
    managed("gcp.binaryauthorization.Attestor", .binary_authorization, .project, .google_discovery, "M80", withProduct(full)),
    managed("gcp.binaryauthorization.AttestorIamMember", .binary_authorization, .project, .google_rest, "M80", withVisual(additive_iam)),
    managed("gcp.binaryauthorization.Policy", .binary_authorization, .project, .google_discovery, "M80", withProduct(retained)),
    ...
    managed("gcp.cloudbuild.Connection", .cloud_build, .location, .google_discovery, "M75", withProduct(full)),
    managed("gcp.cloudbuild.Repository", .cloud_build, .location, .google_discovery, "M75", withProduct(replaceable)),
    managed("gcp.cloudbuild.Trigger", .cloud_build, .location, .google_discovery, "M75", withProduct(full)),
    managed("gcp.cloudbuild.WorkerPool", .cloud_build, .location, .google_discovery, "M75", withProduct(full)),
    ...
    managed("gcp.connectors.Connection", .connectors, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.connectors.ConnectionIamMember", .connectors, .location, .google_rest, "M82", withVisual(additive_iam)),
    managed("gcp.connectors.EndpointAttachment", .connectors, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.connectors.EventSubscription", .connectors, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.connectors.ManagedZone", .connectors, .global, .google_discovery, "M82", withProduct(full)),
    managed("gcp.connectors.RegionalSettings", .connectors, .region, .google_discovery, "M82", withProduct(retained)),
    ...
    managed("gcp.dataform.ReleaseConfig", .dataform, .location, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataform.Repository", .dataform, .location, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataform.RepositoryIamMember", .dataform, .location, .google_rest, "M81", withVisual(additive_iam)),
    managed("gcp.dataform.WorkflowConfig", .dataform, .location, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataform.Workspace", .dataform, .location, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataform.WorkspaceIamMember", .dataform, .location, .google_rest, "M81", withVisual(additive_iam)),
    managed("gcp.datapipelines.Pipeline", .data_pipelines, .location, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataproc.AutoscalingPolicy", .dataproc, .region, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataproc.AutoscalingPolicyIamMember", .dataproc, .region, .google_rest, "M81", withVisual(additive_iam)),
    managed("gcp.dataproc.Cluster", .dataproc, .region, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataproc.ClusterIamMember", .dataproc, .region, .google_rest, "M81", withVisual(additive_iam)),
    managed("gcp.dataproc.WorkflowTemplate", .dataproc, .region, .google_discovery, "M81", withProduct(full)),
    managed("gcp.dataproc.WorkflowTemplateIamMember", .dataproc, .region, .google_rest, "M81", withVisual(additive_iam)),
    managed("gcp.deploy.Automation", .cloud_deploy, .location, .google_discovery, "M76", withProduct(full)),
    managed("gcp.deploy.CustomTargetType", .cloud_deploy, .location, .google_discovery, "M76", withProduct(full)),
    managed("gcp.deploy.DeliveryPipeline", .cloud_deploy, .location, .google_discovery, "M76", withProduct(full)),
    managed("gcp.deploy.DeployPolicy", .cloud_deploy, .location, .google_discovery, "M76", withProduct(full)),
    managed("gcp.deploy.Target", .cloud_deploy, .location, .google_discovery, "M76", withProduct(full)),
    ...
    managed("gcp.eventarc.Enrollment", .eventarc, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.eventarc.EnrollmentIamMember", .eventarc, .location, .google_rest, "M82", withVisual(additive_iam)),
    managed("gcp.eventarc.GoogleApiSource", .eventarc, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.eventarc.GoogleApiSourceIamMember", .eventarc, .location, .google_rest, "M82", withVisual(additive_iam)),
    managed("gcp.eventarc.MessageBus", .eventarc, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.eventarc.MessageBusIamMember", .eventarc, .location, .google_rest, "M82", withVisual(additive_iam)),
    managed("gcp.eventarc.Pipeline", .eventarc, .location, .google_discovery, "M82", withProduct(full)),
    managed("gcp.eventarc.PipelineIamMember", .eventarc, .location, .google_rest, "M82", withVisual(additive_iam)),
    ...
    managed("gcp.kms.CryptoKey", .kms, .location, .google_discovery, "M77", withProduct(retained)),
    managed("gcp.kms.CryptoKeyIamMember", .kms, .location, .google_rest, "M77", withVisualCost(additive_iam)),
    managed("gcp.kms.CryptoKeyVersion", .kms, .location, .google_discovery, "M77", withProduct(retained)),
    managed("gcp.kms.KeyRing", .kms, .location, .google_discovery, "M77", withProduct(retained_replaceable)),
    managed("gcp.kms.KeyRingIamMember", .kms, .location, .google_rest, "M77", withVisualCost(additive_iam)),
    managed("gcp.logging.Bucket", .logging, .location, .google_discovery, "M74", withProduct(full)),
    managed("gcp.logging.Exclusion", .logging, .project, .google_discovery, "M74", withVisualCost(full)),
    managed("gcp.logging.Metric", .logging, .project, .google_discovery, "M74", withProduct(full)),
    managed("gcp.logging.Sink", .logging, .project, .google_discovery, "M74", withProduct(full)),
    managed("gcp.logging.View", .logging, .location, .google_discovery, "M74", withProduct(full)),
    managed("gcp.monitoring.AlertPolicy", .monitoring, .project, .google_discovery, "M73", withProduct(full)),
    managed("gcp.monitoring.Dashboard", .monitoring, .project, .google_discovery, "M73", withProduct(full)),
    managed("gcp.monitoring.NotificationChannel", .monitoring, .project, .google_discovery, "M73", withProduct(full)),
    managed("gcp.monitoring.Service", .monitoring, .project, .google_discovery, "M73", withVisualCost(full)),
    managed("gcp.monitoring.ServiceLevelObjective", .monitoring, .project, .google_discovery, "M73", withVisualCost(full)),
    managed("gcp.monitoring.UptimeCheck", .monitoring, .project, .google_discovery, "M73", withProduct(full)),
    ...
    managed("gcp.privateca.CaPool", .private_ca, .location, .google_discovery, "M80", withProduct(full)),
    managed("gcp.privateca.CaPoolIamMember", .private_ca, .location, .google_rest, "M80", withVisualCost(additive_iam)),
    managed("gcp.privateca.Certificate", .private_ca, .location, .google_discovery, "M80", withProduct(retained)),
    managed("gcp.privateca.CertificateAuthority", .private_ca, .location, .google_discovery, "M80", withProduct(retained)),
    managed("gcp.privateca.CertificateTemplate", .private_ca, .location, .google_discovery, "M80", withProduct(full)),
    managed("gcp.privateca.CertificateTemplateIamMember", .private_ca, .location, .google_rest, "M80", withVisualCost(additive_iam)),
    ...
    managed("gcp.resourcemanager.Folder", .resource_manager, .folder, .google_discovery, "M78", withProduct(full)),
    managed("gcp.resourcemanager.Lien", .resource_manager, .project, .google_discovery, "M78", .{ .declaration = true, .read = true, .create = true, .delete_resource = true, .import_resource = true, .estate = true, .visual = true }),
    managed("gcp.resourcemanager.Project", .resource_manager, .project, .google_discovery, "M78", withProduct(full)),
    ...
    managed("gcp.secret.Secret", .secret_manager, .project, .google_discovery, "M77", withProduct(full)),
    managed("gcp.secret.SecretIamMember", .secret_manager, .project, .google_rest, "M77", withVisualCost(additive_iam)),
    managed("gcp.secret.SecretVersion", .secret_manager, .project, .google_discovery, "M77", withProduct(retained)),
    managed("gcp.securitycenter.BigQueryExport", .security_center, .location, .google_discovery, "M80", withProduct(full)),
    managed("gcp.securitycenter.MuteConfig", .security_center, .location, .google_discovery, "M80", withProduct(full)),
    managed("gcp.securitycenter.NotificationConfig", .security_center, .location, .google_discovery, "M80", withProduct(full)),
    managed("gcp.securitycenter.ResourceValueConfig", .security_center, .location, .google_discovery, "M80", withProduct(full)),
    managed("gcp.securitycenter.Source", .security_center, .organization, .google_discovery, "M80", withProduct(retained)),
    managed("gcp.servicenetworking.Connection", .service_networking, .global, .google_discovery, "M66", withVisual(full)),
    managed("gcp.serviceusage.ServiceIdentity", .service_usage, .project, .google_discovery, "M78", .{ .declaration = true, .read = true, .create = true, .import_resource = true, .visual = true }),
